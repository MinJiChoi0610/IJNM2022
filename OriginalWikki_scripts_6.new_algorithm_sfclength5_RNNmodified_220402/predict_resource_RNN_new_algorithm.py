...
class RNN_resource_modeling:
    def __init__(self, trainfile, threshold_cpu_upper, threshold_cpu_lower, threshold_traffic_upper, threshold_traffic_lower, max_scaleup):
        ...
        df.columns = ['TIME', '1CPU', '1MEMORY', '1IO', '1IO', '1TRAFFIC-RX', '1TRAFFIC-TX', '2CPU', '2MEMORY', '2IO', '2IO', '2TRAFFIC-RX', '2TRAFFIC-TX', '3CPU', '3MEMORY', '3IO', '3IO', '3TRAFFIC-RX', '3TRAFFIC-TX', '4CPU', '4MEMORY', '4IO', '4IO', '4TRAFFIC-RX', '4TRAFFIC-TX', '5CPU', '5MEMORY', '5IO', '5IO', '5TRAFFIC-RX', '5TRAFFIC-TX']
    ...
    def test(self): # 여기서 받는 x_data는 average_resource
