...
import subprocess
import json
# This script will compare the delay of two SFC configurations. One will be taken from input.json and other will be taken from input1.json file.

print("*****************COMPARE DELAY OF TWO SFC******************")
print("---------------------------------------------------------------------------------------------------------")
...
with open('input.json') as f:
    ...
    print("*****************Overall Latency via FIRST SFC******************")
...
with open('input1.json') as f:
    ...
    print("*****************Overall Latency SECOND SFC ******************")
